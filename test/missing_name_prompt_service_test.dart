...
import 'package:last_cards/core/services/missing_name_prompt_service.dart';
...
void main() {
  ...
  test('shouldShowFirstLaunchPrompt returns true once then false', () async {
    ...
    final service = MissingNamePromptService.instance;
  ...
  test('a fresh install with the flag already set never shows the prompt', () async {
    SharedPreferences.setMockInitialValues({'missing_name_prompt_shown': true});
    final service = MissingNamePromptService.instance;
