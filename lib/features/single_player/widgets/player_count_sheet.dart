...
/// Lets the player pick 2, 3, or 4 players; then "Play" navigates
/// to [GameLoadingScreen].
class SPPlayerCountSheet extends ConsumerStatefulWidget {
  const SPPlayerCountSheet({super.key});

  @override
  ConsumerState<SPPlayerCountSheet> createState() => _SPPlayerCountSheetState();
}

class _SPPlayerCountSheetState extends ConsumerState<SPPlayerCountSheet> {
  int? _selectedCount;
  ...
  Widget build(BuildContext context) {
    ...
    final difficultyLabel = session.difficulty?.displayName ?? 'Single Player';
...
class _SPPlayerCountCard extends ConsumerStatefulWidget {
  const _SPPlayerCountCard({
    required this.count,
  ...
  @override
  ConsumerState<_SPPlayerCountCard> createState() => _SPPlayerCountCardState();
}

class _SPPlayerCountCardState extends ConsumerState<_SPPlayerCountCard> {
